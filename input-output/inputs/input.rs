...
fn main() {
    ...
    io::stdin().read_line(&mut integer_input).expect("Failed to read input");
    ...
    io::stdin().read_line(&mut float_input).expect("Failed to read input");
    ...
    io::stdin().read_line(&mut char_input).expect("Failed to read input");
    ...
    io::stdin().read_line(&mut bool_input).expect("Failed to read input");
